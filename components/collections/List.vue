<template>
    ...
    >
      ...
      >
        ...
        >
          <section >
            ...
            <div class="flex">
          <PencilSquareIcon @click="edit(template)" class="h-5 w-5" aria-hidden="true" ></PencilSquareIcon>
      ...
      <div class="row-span-3 col-span-4 bg-white h-[calc(100vh-150px)]">
        <div v-if="!emailTemplate.data._rawValue">
        ...
        <CollectionsEdit :templateId="id" :templateName="name" :templateSubject="subject" :templateBody="body" :key="render"/>
      </div>
